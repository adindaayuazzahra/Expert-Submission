...
void main() {
  ...
  final routes = <String, WidgetBuilder>{
    ...
    '/next': (context) => _createAnotherTestableWidget(HomeTvPage()),
    TVDetailPage.ROUTE_NAME: (context) => const FakeDestination(),
    TopRatedTVPage.ROUTE_NAME: (context) => const FakeDestination(),
    PopularTVPage.ROUTE_NAME: (context) => const FakeDestination(),
